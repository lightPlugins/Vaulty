...
public interface Economy {
    ...
    /**
     *
     * @deprecated Outdated methode. Please use {@link #hasAccount(UUID)} instead.
     */
     @Deprecated
    ...
    /**
     * @deprecated Outdated methode. Please use {@link #getBalance(UUID)} instead.
     */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #getBalance(UUID, String)} instead.
      */
    @Deprecated
    ...
    /**
     * @deprecated Outdated methode. Please use {@link #has(UUID, BigDecimal)} instead.
     */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #has(UUID, String, BigDecimal)} instead.
      */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #withdrawPlayer(UUID, BigDecimal)} instead.
      */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #withdrawPlayer(UUID, String, BigDecimal)} instead.
      */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #depositPlayer(UUID, BigDecimal)} instead.
      */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #depositPlayer(UUID, String, BigDecimal)} instead.
      */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #createBank(UUID, UUID)} instead.
      */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #deleteBank(UUID)} instead.
      */
     @Deprecated
     EconomyResponse deleteBank(String name);

     /**
      * @deprecated Outdated methode. Please use {@link #bankBalance(UUID)} instead.
      */
     @Deprecated
     EconomyResponse bankBalance(String name);

     /**
      * @deprecated Outdated methode. Please use {@link #bankHas(UUID, BigDecimal)} instead.
      */
     @Deprecated
     EconomyResponse bankHas(String name, double amount);

     /**
      * @deprecated Outdated methode. Please use {@link #bankWithdraw(UUID, BigDecimal)} instead.
      */
     @Deprecated
     EconomyResponse bankWithdraw(String name, double amount);

     /**
      * @deprecated Outdated methode. Please use {@link #bankDeposit(UUID, BigDecimal)} instead.
      */
     @Deprecated
     EconomyResponse bankDeposit(String name, double amount);

     /**
      * @deprecated Outdated methode. Please use {@link #isBankOwner(UUID, UUID)} instead.
      */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #isBankMember(UUID, UUID)} instead.
      */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #getBanksAsUUID()} instead.
      */
     @Deprecated
     List<String> getBanks();

     /**
      * @deprecated Outdated methode. Please use {@link #createPlayerAccount(UUID)} instead.
      */
     @Deprecated
     ...
     /**
      * @deprecated Outdated methode. Please use {@link #createPlayerAccount(UUID, String)} instead.
      */
     @Deprecated
